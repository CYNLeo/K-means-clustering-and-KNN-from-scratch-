...
Original file is located at
    https://colab.research.google.com/drive/1NoG14QEFodd2A4SE4-V7sPm6DluQQ45o
...
task3 = pd.read_csv("/content/task3_knn_prediction.csv")

task3arr = np.array(task3)
...
np.sum(task3arr != np.expand_dims(prediction[1:],axis = 1))
